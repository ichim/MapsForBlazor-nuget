    ...
    public class StreamPoints
    {
        public List<StreamPoint> points = new List<StreamPoint>()
        {
               ...
               type = "Drone",
                      value = new DroneFuel()
                    {
                        percentages = new double[3] { 20, 40, 40 },
                        labels = new string[3] { "Low", "Medium" , "Heigh"},
                        colors = new string[3] { "white", "yellow", "red" },
                        value =1
                    }
                },
                  new StreamPoint()
                {
                    ...
                    type = "Drone",
                      value = new DroneFuel()
                    {
                        percentages = new double[4] { 20, 40, 20, 20 },
                        labels = new string[4] { "Low", "Medium Low", "Medium" , "Height"},
                        colors = new string[4] { "red", "orange", "yellow", "green" },
                        value =2
                    }
                },
                     new StreamPoint()
        ...
        public List<StreamPoint> test = new List<StreamPoint>()
        {
                ...
                new StreamPoint()
                {
                    ...
                    {
                        percentages = new double[3] { 20, 40, 40 },
                        labels = new string[3] { "Low", "Medium" , "Height"},
                        colors = new string[3] { "white", "yellow", "red" },
                        value =1
                    }
                },
                  new StreamPoint()
                {
                    ...
                    guid = new Guid("00000000-0000-0000-0000-000000000004"),
                     type = "Industrial",
                          value = new IndustrialValues()
                    {
                        production = new double[4] { 200, 280, 300, 50 },
                        texts = new string[4] { "Auto", "Air", "Moto", "Cicle" },
                        classes = new string[4] { "white", "yellow","brown","green" }
                    }
                },
                //     new StreamPoint()
                //{
